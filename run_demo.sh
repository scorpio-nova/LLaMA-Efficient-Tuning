...
LLAMA2_PATH="/root/models/llama-tuned/llama-2-7b-alpaca-augmented_steps-10-30-17-10"
# metamath my version
# LLAMA2_PATH="/root/models/llama-tuned/llama-2-7b-alpaca-meta_math-10-28-10-20"
